...
export async function saveQuizResult(questions, answers, score){
    ...
    // Whatever questions are not correct take them from 
    // "questionResults" array and filter them out
    ...
    if(wrongAnswers.length > 0){
      ...
      try {
        ...
        const response = result.response; // This won't be in json format
    ...
    // Let's store all of this inside our database
    try {
